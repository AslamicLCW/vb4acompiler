...
public final class Compiler {
  ...
  private static final String APP_NAME = System.getenv("APPNAME");
  private static final String ICON_FILE= System.getenv("ICONFILE");
  ...
  public static boolean compile(Platform platform, Project project, PrintStream out,
    ...
    if (compiler.errorCount > 0) {
      compiler.out.println("编译错误: " + compiler.errorCount);
    } else {
      ...
      case Android:
        ...
        File outputfile = new File(drawableDir, "simple.png");
        ...
        out.println("打包工程：" + project.getProjectName());
  ...
  public static List<ClassFile> compileForUnitTesting(Project project) {
    ...
    for (Project.SourceDescriptor arg : project.getSources()) {
      ...
      System.out.println("VB4A正在编译：" + file.getPath());
